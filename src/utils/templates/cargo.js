export default function CargoTemplate(data, link) {
	...
	<body>
		...
		<main>
			...
			<p><strong>Enquiry Date</strong> : ${data.enq_date || "-"}</p>
			<p><strong>Offer Bid Due Date and Time</strong> : ${data.offer_bid || "-"}</p>
			<p><strong>Source</strong> : ${data.source || "-"}</p>
			<p><strong>Shipper/Charter</strong> : ${data.shipper || "-"}</p>
		...
		<footer>
			<p>
				This mail is generated by the system. Do not reply to this mail. For any
				assistance Contact <strong><a href="mailto:help@puyvast-dailyupdates.co.in?subject=&body=">Support Team</a></strong>
			</p>
		</footer>
	</body>
</html>`;
